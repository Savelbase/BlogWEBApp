<%--@elvariable id="poster" type="org.itstep.domain.Post"--%>
<%--
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <article>
                ...
                <header class="mb-4">
                    <!-- Post title-->
                    <h1 class="fw-bolder mb-1">${poster.name}</h1>
                    <!-- Post meta content-->
                    <div class="text-muted fst-italic mb-2">Posted on ${poster.getStringDate()}</div>
                    <!-- Post categories-->
                    <a class="badge bg-secondary text-decoration-none link-light" href="#!">Web Design</a>
                    <a class="badge bg-secondary text-decoration-none link-light" href="#!">Freebies</a>
                </header>
                <!-- Preview image figure-->
                <figure class="mb-4"><img class="img-fluid rounded" src="${poster.fileUrl}" alt="..."/></figure>
                <!-- Post content-->
                <section class="mb-5">
                    <p class="fs-5 mb-4">${poster.text}</p>
                </section>
            </article>
            <!-- Comments section-->
            <section class="mb-5">
